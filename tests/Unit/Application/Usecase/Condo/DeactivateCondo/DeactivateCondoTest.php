...
namespace App\Tests\Unit\Application\Usecase\Condo\DeactivateCondo;
...
class DeactivateCondoTest extends TestCase
{
    private const DATA = [
    ...
    public function testActivateCondo(): void
    {
        ...
        self::assertEquals(true, $responseDto->condoData['isActive']);
    }
